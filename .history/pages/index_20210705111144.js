    ...
    <div className="">
      ...
      <form className=" flex flex-col items-center mt-44 flex-grow " action="">
        <Image
          ...
          width={300}
        />
        <div className="flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg max-w-md border border-gray-500 rounded-full px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl ">
